    ...
    <div className="p-8">
      <div className="flex w-full justify-end  mb-6">
        <Link href={"/home/invites/create"}>
          <button className="btn bg-purple-500 text-white hover:bg-purple-500 hover:shadow-lg">
            <svg
      ...
      <div className="bg-white min-h-60 p-4 rounded-lg shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
        ...
        <div className="flex overflow-x-auto">
          {invitationsUpcomming.map((iu) => (
            <div className="flex p-4  mr-2 min-w-80 cursor-pointer">
              ...
              {/* Info */}
              <div className="ml-2">
                <div>{iu.visitor.first_name + " " + iu.visitor.last_name}</div>
                <div className="text-xs text-gray-500">{iu.visitor.email}</div>
